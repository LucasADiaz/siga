                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @can('users.index')  
                                   <a class="dropdown-item" href="{{ route('users.index') }}"> Ver Usuarios
                                    </a>
                                @endcan
                                {{-- @can('users.edit')                                
                                   <a class="dropdown-item" href="{{ route('users.edit') }}"> Editar usuarios
                                        </a>
                                @endcan --}}
{{-- 
                                @can('users.destroy')  
                                    <a class="dropdown-item" href="{{ route('users.destroy') }}"> Eliminar Usuarios
                                        </a>
                                @endcan
                                     --}}
                                    <a class="dropdown-item" href="{{ route('roles.index') }}"> Ver Roles
                                    </a>

                                    <a class="dropdown-item" href="{{ route('roles.create') }}"> Crear Roles
                                    </a>
{{-- 
                                    <a class="dropdown-item" href="{{ route('roles.edit') }}"> Editar Roles
                                    </a> --}}
{{-- 
                                @can('roles.destroy') 
                                    <a class="dropdown-item" href="{{ route('roles.destroy') }}"> Eliminar Roles
                                    </a> 
                                @endcan --}}
