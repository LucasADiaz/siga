      ...
      <div class="col-md-12">
          <div class="card">
              ...
              <form method="POST" action="{{ route('legajos.store')}}" onsubmit="enviado()">
                ...
                <!-- DATOS DEL ALUMNO -->
                @include('legajos.crearLegajos.alumno.alumnoform', $alumnoPorDefecto)
                <!--DATOS PERSONALES DE LA MADRE-->
                @include('legajos.crearLegajos.madre.madreform', array_merge($madrePorDefecto, array('madre_mismodomicilio' => $madre_mismodomicilio)))
                <!--DATOS PERSONALES DEL PADRE-->
                @include('legajos.crearLegajos.padre.padreform', array_merge($padrePorDefecto, array('padre_mismodomicilio' => $padre_mismodomicilio)))
                <!--DATOS PERSONALES DEL TUTOR-->
                @include('legajos.crearLegajos.tutor.tutorform', array_merge($tutorPorDefecto, array('tutor_mismodomicilio' => $tutor_mismodomicilio)))
                <!-- DATOS DE TUTORES SUPLENTES -->
                
                @include('legajos.crearLegajos.tutorsup.tutorsupform', $tutorSupPorDefecto)
