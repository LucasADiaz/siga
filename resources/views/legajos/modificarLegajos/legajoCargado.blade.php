          ...
          <div class="card">
              ...
              <form method="POST" action="{{ route('legajos.update')}}" onsubmit="enviado()">
                ...
                <!-- FORMULARIO DEL ALUMNO -->
                    @include('legajos.crearLegajos.alumno.alumnoform', $datosAlumno)
                <!-- FORMULARIO DE LA MADRE -->
                    @include('legajos.crearLegajos.madre.madreform', $datosMadre)
                <!-- FORMULARIO DEL PADRE -->
                    @include('legajos.crearLegajos.padre.padreform', $datosPadre)
                <!--DATOS PERSONALES DEL TUTOR-->
                    @include('legajos.crearLegajos.tutor.tutorform', $datosTutor)
                <!-- DATOS DE TUTORES SUPLENTES -->
                    @include('legajos.crearLegajos.tutorsup.tutorsupform', $datosTutorSup)
